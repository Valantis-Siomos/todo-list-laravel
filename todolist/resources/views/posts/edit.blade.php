...
<body class="bg-gray-100 p-8">
  ...
  <h1 class="text-3xl font-bold mb-6 text-center text-gray-800">Edit Post</h1>
  ...
  <form method="POST" action="{{ route('posts.update', $post->id) }}"
    ...
    <textarea name="content" rows="6"
              class="w-full mb-4 px-3 py-2 border rounded focus:ring-2 focus:ring-blue-600">{{ old('content', $post->content) }}</textarea>
